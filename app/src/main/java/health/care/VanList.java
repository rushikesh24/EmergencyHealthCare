...
public class VanList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_van_list);
        ...
        mLayoutManager = new LinearLayoutManager(VanList.this);
            ...
            protected void populateViewHolder(ContentHolder viewHolder, GetSet model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent pd = new Intent(VanList.this,Details.class);
                        pd.putExtra("Post ID",post_key);
                        pd.putExtra("Post Parent",query);
                        pd.putExtra("Identifier","Mortuary Van  Registrations");
                        startActivity(pd);
                    }
                });
